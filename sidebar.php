...
<div class="card">
        ...
        <div class="card-body" style="border-top:0.2px solid #e9e9e9 ;">
            ...
            <ul class="list-group">
                <li class="list-group-item" <?php if (isset($_GET['orders'])) {echo  "style = 'background-color:#fe4231'";} ?>>
                ...
                <li class="list-group-item" <?php if (isset($_GET['details'])) { echo  "style = 'background-color:#fe4231'";} ?>>
