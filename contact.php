            ...
            <div class="col-lg-6 offset-lg-1">
                ...
                <div class="contact-form">
                    <div class="leave-comment">
                        ...
                        <p>Keep patience for answer of your questions.</p>
                        <form action="contact.php" class="comment-form">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <button class="site-btn" name="submit">Send</button>
                                </div>
                            </div>
                        </form>
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $receiver_mail = 'fazitanveer2@gmail.com';
