        ...
        <div class="row" style="padding-bottom: 40px;">
            <div class="col-lg-3">
                <div class="footer-left">
                    <div class="footer-logo">
                        <a href="index.php"> <span>Faizan & waleed</span>
                        </a>
                    </div>
                    <ul>
                        <li>+92 3070286263</li>
                        <li>fazitanveer2@gmail.com</li>
                        <li>UAF, Faisalabad</li>
                    </ul>
            ...
            <div class="col-lg-2 offset-lg-1">
                <div class="footer-widget">
                    ...
                    <ul>
                        ...
                        <li><a href="index.php">© . All Rights Reserved </a></li>
            ...
            <div class="col-lg-4">
                <div class="newslatter-item">
                    <h5>Keep in touch</h5>
                    <p>Get E-mail updates about latest special offers...</p>
